...
for (i in 1:18)
{
  ...
  data$huc2digit = floor(data$HUC_12/(10^10)) # has all 18 huc units
  huc2constraint = i
  ...
  ofilename = sprintf('G:/My Drive/research/sdm_modeling/spdata/projection_area/by_huc/original/huc%s.csv',namecode)
  names(projareacomid) = 'comid'
